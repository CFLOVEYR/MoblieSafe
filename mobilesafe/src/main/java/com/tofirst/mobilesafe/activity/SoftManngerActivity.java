...
public class SoftManngerActivity extends Activity {
    //系统剩余内存
    ...
    private void initUI() {
        ...
        list_view_mannger.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                dissmissPoupWindow();
                if (obj != null) {
                    SoftManangerInfo info = (SoftManangerInfo) obj;
//                    Log.i(TAG, "信息为------------------" + info);
                    TextView tv = new TextView(SoftManngerActivity.this);
                    ...
                    popupWindow = new PopupWindow(tv, LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
                    //设置背景颜色
