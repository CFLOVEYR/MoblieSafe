...
public class SettingAddressItemView extends RelativeLayout {
	...
	// 带样式的
	public SettingAddressItemView(Context context, AttributeSet attrs, int defStyle) {
	...
	// 带属性的
	public SettingAddressItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	...
	// new 的时候
	public SettingAddressItemView(Context context) {
		super(context);
		initView();
	}
