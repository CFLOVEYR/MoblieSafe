...
public class SettingWatchDogItemView extends RelativeLayout {
	...
	// 带样式的
	public SettingWatchDogItemView(Context context, AttributeSet attrs, int defStyle) {
	...
	// 带属性的
	public SettingWatchDogItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	...
	// new 的时候
	public SettingWatchDogItemView(Context context) {
		super(context);
		initView();
	}
