...
public class SettingUpdateItemView extends RelativeLayout {
	...
	// 带样式的
	public SettingUpdateItemView(Context context, AttributeSet attrs, int defStyle) {
	...
	// 带属性的
	public SettingUpdateItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	...
	// new 的时候
	public SettingUpdateItemView(Context context) {
		super(context);
		initView();
	}
