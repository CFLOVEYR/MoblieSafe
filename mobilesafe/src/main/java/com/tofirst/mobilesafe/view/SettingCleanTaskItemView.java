...
public class SettingCleanTaskItemView extends RelativeLayout {
	...
	// 带样式的
	public SettingCleanTaskItemView(Context context, AttributeSet attrs, int defStyle) {
	...
	// 带属性的
	public SettingCleanTaskItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	...
	// new 的时候
	public SettingCleanTaskItemView(Context context) {
		super(context);
		initView();
	}
